...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children, activeSection, onSectionChange }) => {
  ...
  const menuItems = [
    ...
    { id: 'reports', label: 'Analytics & Reports', icon: FiBarChart2 },
  ];
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside
        ...
        } bg-gradient-to-b from-red-600 to-pink-700 text-white transition-all duration-300 ease-in-out flex flex-col shadow-2xl`}
      >
        {/* Logo & Toggle */}
          ...
          <div className="p-4 border-b border-red-500">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-red-200">System Admin</p>
              </div>
            </div>
          </div>
        )}
            ...
            return (
              <button
                ...
                className={`w-full flex items-center space-x-3 px-4 py-3 transition-all duration-200 ${
                  isActive
                    ? 'bg-white text-red-600 border-r-4 border-red-600 shadow-lg'
        ...
        <div className="border-t border-red-500 p-4 space-y-2">
          {sidebarOpen ? (
            <>
              <button className="w-full flex items-center space-x-3 px-4 py-2 text-white hover:bg-red-500 rounded-lg transition-colors">
                <FiSettings size={18} />
                <span>Settings</span>
              </button>
              <button
                ...
                className="w-full flex items-center space-x-3 px-4 py-2 text-white hover:bg-pink-600 rounded-lg transition-colors"
              >
                <FiLogOut size={18} />
                <span>Logout</span>
              </button>
            ...
            <>
              <button className="w-full flex justify-center p-2 text-white hover:bg-red-500 rounded-lg transition-colors">
                <FiSettings size={18} />
              </button>
              <button
                onClick={() => {
                ...
                className="w-full flex justify-center p-2 text-white hover:bg-pink-600 rounded-lg transition-colors"
              >
                <FiLogOut size={18} />
              </button>
            </>
